...
// lockFile is unsupported off Unix. filelog already depends on directory fsync
...
func lockFile(*os.File) error {
	return fmt.Errorf("filelog: advisory file locking is not supported on this platform")
}

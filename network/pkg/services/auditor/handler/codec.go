...
// RFC 3339 UTC second-precision string. Mapped to InvalidArgument. Reproduced
// (not shared) from payloadresolver/handler and chainmanager/handler's own
// copies — the codebase's convention for keeping L2 surfaces decoupled.
var errMalformedIssuedAt = errors.New("auditor: malformed issued_at")

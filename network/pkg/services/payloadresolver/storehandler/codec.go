...
// (not shared) from payloadresolver/handler's own copy — the codebase's
// convention for keeping wireauth-verifying surfaces decoupled.
var errMalformedIssuedAt = errors.New("storehandler: malformed issued_at")
